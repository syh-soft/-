...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> getAddResult() async {
    int a= int.parse(_addNumber1Controller.value.text);
    int b=int.parse(_addNumber2Controller.value.text);

    int result= 0;
    try {
      result = await Untitled1.getResult(a, b);
      setState(() {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion = await Untitled1.platformVersion;
    } on PlatformException {
